...
async function init(){
  ...
  // Manual input: numeric keypad for slab number (mobile hint)
  const slabNumberInput = document.querySelector('#addSlabForm input[name="slab_number"]');
  if(slabNumberInput){
    slabNumberInput.setAttribute('inputmode','numeric');
    slabNumberInput.setAttribute('pattern','[0-9]*');
  }
